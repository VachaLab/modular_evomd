...
def main():
    ...
    if args.show_defaults:
        ...
        """
        evo = get_evolver(args)
        sequences_pre = ["AALLDRIMLEKIQIVVRSIQVW", "AELWWRWYLEKWDIVVRIIEVW", "AAFWDRWYLEKWDIVVRIIQVW", 
                         "AALWWRRIMLEKIDIVVRIIQH", "AAFWWRWYLEKIDIVVRIIQVW", "AAFWWRWYLEKADIVVRIIQVW", 
                         "AALWWRMYLEKWDIVVRIIQVW", "AALWWRGYLEKWDIVVRIIQVW", "YAEENFRIMLEKIDIVVRLIQH", 
                         "AALWWRWYLEYIDIVVRIIQVW", "AALWDRIMLEKIDIVVRAIQVW", "AALWWRIMLEYIDIVVRSIQVW", 
                         "AALLDRIMLEYIDIVVRSIDVW", "AALWWRWYGEKIDIVVRSIQVW", "AALLDRIMLEYIHIVVRIIQVW", 
                         "AALWWRWMLEKIDIVVRIIQVW"]

        sequences_new = ["AAFLDRWMLEKIDRVVRIIQVW", "AALLDRIMLEKADIVVRIIQVW", "AALLDRTMLEKWDRVVRIIQVW", 
                         "AALWWRWYLEKIDIVVRIIQVA", "GAEENFRIMLEKIDIVVRIIQI", "AAFLWRWMLEKIDITVRIIQVW", 
                         "AALLDFRIMLEKIDIVVRIIQH", "AALLDRIYLEYIDIVVRSIQVW", "AALWWRWYLEKADIVVRIIQVW", 
                         "AALWWRWYLEKWEIVVRIIQVW", "AALLDRIMLEAWDIVVRSIQVW", "AAFWWRWYLEKWDIVVRIIQVW", 
                         "AALLDRIMLEYNDIVVRIIQVW", "YALLDRIMLEYIDIVVRSAQVW", "YAEENFQIMLEKIDIVVRIIQH", 
                         "AALWWRWYLEKWDIFVRIIQVW"]

        for seq in evo.sequences + evo.discarded_sequences:
            print(seq)
            if seq.sequence in sequences_pre:
                seq.generation = 7
                print(f'new generation: {seq}: 7')
            if seq.sequence in sequences_new:
                seq.generation = 8
            else:
                continue
        evo.generations = 8
